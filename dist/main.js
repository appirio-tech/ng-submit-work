...
(function() {
  ...
  SubmitWorkVisualController = function($scope, $rootScope, $state, $document, SubmitWorkService, SubmitWorkUploaderService, RequirementService) {
    ...
    vm.makeSelection = function(model, value) {
