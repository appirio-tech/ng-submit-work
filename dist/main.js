...
$templateCache.put("views/submit-work-complete.directive.html","<modal show=\"true\" class=\"full\"><header class=\"flex column middle center flex-grow\"><div class=\"icon-house\"><div class=\"icon biggest checkmark\"></div></div><h1><strong>awesome!</strong></h1><p>Your <span class=\"app-name\">a very very very long app name</span> app - will be reviewed by a Copilot to provide you with a detailed quote.</p><button ui-sref=\"view-work-multiple\" class=\"action wider\">submit for quote</button></header><footer class=\"flex\"><div class=\"estimate\"><h3>Estimate</h3><table><thead><tr><td>$50k - $80k</td><td>35 man days</td></tr></thead><tbody><tr><td>cost estimate</td><td>time estimate</td></tr></tbody></table></div><div class=\"divider flex column stretch\"><div class=\"border flex-grow\"></div></div><div class=\"cost\"><h3>Cost breakdown range</h3><table><thead><tr><td>$XX - $XX</td><td>$XX - $XX</td></tr></thead><tbody><tr><td>design</td><td>development</td></tr></tbody></table><p>*Includes any custom features requested</p></div></footer></modal>");}]);
(function() {
  'use strict';
  var directive;
