...
angular.module("appirio-tech-ng-submit-work").run(["$templateCache", function($templateCache) {$templateCache.put("views/nav.html","<ul class=\"navs\"><li class=\"active\"><a ui-sref=\"submit-work-features\">Features</a></li><li><a ui-sref=\"submit-work-visuals\">Visual Design</a></li><li><a ui-sref=\"submit-work-development\">Development</a></li></ul><progress value=\"2\" max=\"3\"></progress>");
