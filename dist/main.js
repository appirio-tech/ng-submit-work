...
(function() {
  ...
  SubmitWorkTypeController = function($scope, $rootScope, $state, $document, SubmitWorkService, ProjectsAPIService, RequirementService) {
    var activate, getUpdates, isValid, localStorageKey, recent, userProjectNames, vm;
    vm = this;
    vm.loading = false;
    ...
    vm.validateSection = function(nextId, models, scrollActivated) {
      ...
      if (Array.isArray(models)) {
        ...
        if ((ref = vm[model]) != null ? ref.length : void 0) {
          if ((userProjectNames != null ? userProjectNames.indexOf(vm[model].toLowerCase()) : void 0) > -1) {
            vm[modelError] = true;
            foundErrors = true;
          } else {
            vm[modelError] = false;
    ...
    activate = function() {
      ...
      return resource.$promise.then(function(response) {
        var projectNames;
        projectNames = response != null ? response.map(function(project) {
          return project.name.toLowerCase();
        }) : void 0;
        return userProjectNames = projectNames || [];
      });
    };
    activate();
    return vm;
...
(function() {
  ...
  SubmitWorkVisualController = function($scope, $rootScope, $state, $document, SubmitWorkService, SubmitWorkUploaderService, RequirementService) {
    ...
    vm.toggleSelection = function(model, value) {
      if (vm[model] === value) {
    ...
    vm.toggleColorSelection = function(model, value) {
...
(function() {
  ...
  SubmitWorkFeaturesController = function($scope, $rootScope, SubmitWorkService, SubmitWorkAPIService, SubmitWorkUploaderService, RequirementService) {
    ...
    vm.activeFeatureChangedNotes = function() {
      ...
      if ((ref = vm.updatedFeatures) != null) {
        ref.forEach(function(feature) {
          ...
          if (vm.activeFeature.id) {
            if (feature.id === ((ref1 = vm.activeFeature) != null ? ref1.id : void 0) && feature.notes !== ((ref2 = vm.activeFeature) != null ? ref2.notes : void 0)) {
              return changedNotes = true;
            }
          } else {
            if (feature.title === ((ref3 = vm.activeFeature) != null ? ref3.title : void 0) && feature.notes !== ((ref4 = vm.activeFeature) != null ? ref4.notes : void 0)) {
              return changedNotes = true;
            }
          }
        });
    ...
    vm.activateFeature = function(feature) {
      ...
      vm.showDefineFeaturesForm = false;
      vm.addingCustomFeature = false;
      return vm.activePreview = feature.title;
    };
  ...
  SubmitWorkDevelopmentController = function($scope, $rootScope, $state, SubmitWorkService, SubmitWorkUploaderService) {
    ...
    vm.toggleSelection = function(model, value) {
      if (vm.work[model] === value) {
        return vm.work[model] = null;
      } else {
        return vm.work[model] = value;
      }
    };
    vm.save = function(done, kickoff) {
