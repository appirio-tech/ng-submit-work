...
$templateCache.put("views/submit-work-aside.directive.html","<div class=\"fixed-wrapper\"><div class=\"project\"><div class=\"name\">{{ work.name }}</div><div class=\"type\">{{ work.requestType }}</div><div class=\"price\">{{asideService.getEstimate() | estimate}}</div></div><nav role=\"navigation\"><ul id=\"submit-work-nav\"><li ng-class=\"{ completed: completed[\'aboutProject\']}\"><p>About Project</p><ul><li><a state=\"name\" ng-click=\"activeState = \'name\'\" class=\"name current\">Project Name</a></li><li><a state=\"type\" ng-click=\"activeState = \'type\'\" class=\"type current\">Project Type</a></li><li><a state=\"brief\" ng-click=\"activeState = \'brief\'\" class=\"brief current\">Project Specs</a></li><li><a state=\"competitors\" ng-click=\"activeState = \'competitors\'\" class=\"competitors current\">Similar Apps</a></li></ul></li><li ng-class=\"{ completed: completed[\'users\']}\"><p>App Users</p><ul><li><a state=\"users\" ng-click=\"activeState = \'users\'\" class=\"users current\">Your Users</a></li></ul></li><li ng-class=\"{ completed: completed[\'features\']}\"><p>App Features</p><ul><li><a state=\"features\" ng-click=\"activeState = \'features\'\" class=\"features current\">Choose Your Features</a></li></ul></li><li ng-class=\"{ completed: completed[\'design\']}\"><p>App design</p><ul><li><a state=\"designs\" ng-click=\"activeState = \'designs\'\" class=\"designs current\">Upload Design Files</a></li></ul></li><li ng-class=\"{ completed: completed[\'launch\']}\"><p>Launch App</p><ul><li><a state=\"estimate\" ng-click=\"activeState = \'estimate\'\" class=\"estimate current\">Initial Estimate</a></li></ul></li></ul></nav></div>");
