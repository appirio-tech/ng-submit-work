...
$templateCache.put("views/submit-work-development.directive.html","<header><ul class=\"navs flex-center\"><li ng-class=\"{ active: vm.section == 1 }\"><a ui-sref=\"submit-work-features({ id: vm.workId })\">Features</a></li><li ng-class=\"{ active: vm.section == 2 }\"><a ui-sref=\"submit-work-visuals({ id: vm.workId })\">Visual Design</a></li><li ng-if=\"vm.projectType == \'DESIGN_AND_CODE\'\" ng-class=\"{ active: vm.section == 3 }\"><a ui-sref=\"submit-work-development({ id: vm.workId })\">Development</a></li></ul><progress value=\"{{ vm.section }}\" max=\"{{ vm.numberOfSections }}\"></progress><div class=\"house\"><div class=\"icon warning biggest\"></div></div><h1>Development</h1><p>Help us understand the technical requirements of your app.</p></header><modal show=\"vm.uploadSpecs\" background-click-close=\"background-click-close\" class=\"upload-documents\"><div class=\"upload\"><div class=\"icon upload\"></div><h2>Upload your <strong>Development specs</strong></h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><ap-uploader config=\"vm.uploaderConfig\" uploading=\"vm.uploaderUploading\" has-errors=\"vm.uploaderHasErrors\"></ap-uploader><button class=\"wider continue action\">kick off project</button></div></modal><div flush-height=\"flush-height\" class=\"flush-height flex column\"><ul class=\"interactive flex center middle flex-grow selectable-choices\"><li><div class=\"icon\"></div><h3>Define development specs</h3><button type=\"button\" ng-click=\"vm.defineSpecs = !vn.defineSpecs\" class=\"action wide\">select</button></li><li><div class=\"icon\"></div><h3>Upload development specs</h3><button ng-click=\"vm.uploadSpecs = !vm.uploadSpecs\" class=\"action wide\">select</button></li></ul><button ng-click=\"vm.save(true)\" class=\"continue wider action\">kick off project</button></div><modal show=\"vm.defineSpecs\" background-click-close=\"background-click-close\" class=\"full define-development\"><ul class=\"nav\"><li><button ng-click=\"vm.viewPrevious()\" class=\"clean\">&lt;</button></li><li><button ng-click=\"vm.activateModal(\'fonts\')\" ng-class=\"{active: vm.activeStyleModal == \'fonts\'}\" class=\"clean\">fonts</button></li><li><button ng-click=\"vm.activateModal(\'colors\')\" ng-class=\"{active: vm.activeStyleModal == \'colors\'}\" class=\"clean\">colors</button></li><li><button ng-click=\"vm.activateModal(\'icons\')\" ng-class=\"{active: vm.activeStyleModal == \'icons\'}\" class=\"clean\">icons</button></li><li><button ng-click=\"vm.viewNext()\" class=\"clean\">&gt;</button></li></ul><main ng-show=\"false\" class=\"flex column center flex-grow\"><h2>Do you require users to have <strong>offline access to data</strong>?</h2><p>Do your users need to be able to interact with the application when they are unable to connect to the internet (over the air or via wifi)?</p><ul class=\"or-choices flex center middle\"><li><button ng-model=\"vm.work.offlineAccess\" label=\"yes\" value=\"true\" selectable=\"selectable\" type=\"button\" class=\"big widest\"></button><p>Users will need to interact with the app even when offline.  This feature increases complexity and costs.</p></li><li class=\"or\"><div class=\"house\">OR</div></li><li><button ng-model=\"vm.work.offlineAccess\" label=\"no\" value=\"false\" selectable=\"selectable\" type=\"button\" class=\"big widest\"></button><p>The application will gracefully present a message to the user to please connect to the internet.</p></li></ul></main><main ng-show=\"false\" class=\"flex column center flex-grow\"><h2>Personal information</h2><p>Is there any level of personal information? (stored or transmitted)</p><ul class=\"or-choices flex center middle\"><li><button ng-model=\"vm.work.usesPersonalInformation\" label=\"yes\" value=\"true\" selectable=\"selectable\" type=\"button\" class=\"big widest\"></button><p>Storing and/or transmitting personal information increases security and encryption needs which adds complexity and cost.</p></li><li class=\"or\"><div class=\"house\">OR</div></li><li><button ng-model=\"vm.work.usesPersonalInformation\" label=\"no\" value=\"false\" selectable=\"selectable\" type=\"button\" class=\"big widest\"></button><p>The app is not transferring or storing personal information.</p></li></ul></main><main ng-show=\"false\" class=\"security flex column center flex-grow\"><h2>What level of <strong>security do you need</strong>?</h2><ul class=\"selectable-choices flex center\"><li><div class=\"img\"></div><label>No security</label><button selectable=\"selectable\" type=\"button\" ng-model=\"vm.work.securityLevel\" value=\"vm.securityLevels.none\"></button></li><li><div class=\"img\"></div><label>Minimal security</label><button selectable=\"selectable\" type=\"button\" ng-model=\"vm.work.securityLevel\" value=\"vm.securityLevels.minimal\"></button></li><li><div class=\"img\"></div><label>Complete security</label><button selectable=\"selectable\" type=\"button\" ng-model=\"vm.work.securityLevel\" value=\"vm.securityLevels.complete\"></button></li></ul></main><main ng-show=\"true\" class=\"third-party-integrations flex column center flex-grow\"><h2>How many 3rd party integrations</strong>?</h2><p>Enter the number of 3rd party integrations so we can estimate effort involved.</p><input type=\"number\" min=\"1\" max=\"6\" ng-model=\"vm.work.numberOfApiIntegrations\"/></main><footer><button ng-hide=\"vm.backButtonDisabled\" ng-click=\"vm.viewPrevious()\" class=\"wider\">back</button><button ng-hide=\"vm.nextButtonDisabled\" ng-click=\"vm.viewNext()\" class=\"action action wider\">next</button><button ng-show=\"vm.showFinishDesignButton\" ng-click=\"vm.save()\" class=\"action wider\">Save</button></footer></modal>");
