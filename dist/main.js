...
(function() {
  ...
  SubmitWorkController = function($scope, SubmitWorkService, NavService, $state, FeatureService) {
    ...
    getWork = function() {
      return SubmitWorkService.work;
    };
    activate = function() {
      var ref;
      $scope.$watch(getWork, function() {
  ...
  controller = function($scope, SubmitWorkService, NavService) {
    ...
    activate = function() {
      $scope.$watch('features', function() {
        return vm.features = $scope.features;
      });
