...
angular.module("appirio-tech-ng-submit-work").run(["$templateCache", function($templateCache) {$templateCache.put("views/nav.html","<ul class=\"navs\"><li class=\"active\"><a ui-sref=\"submit-work-features({ id: vm.workId })\">Features</a></li><li><a ui-sref=\"submit-work-visuals({ id: vm.workId })\">Visual Design</a></li><li><a ui-sref=\"submit-work-development({ id: vm.workId })\">Development</a></li></ul><progress value=\"2\" max=\"3\"></progress>");
...
(function() {
  ...
  SubmitWorkVisualController = function($scope, $rootScope, $state, SubmitWorkService, Optimist, API_URL, RequirementService) {
    var activate, configureUploader, getUpdates, onChange, updateButtons, vm;
    vm = this;
    ...
    onChange = function() {
      ...
      return vm.colors.forEach(function(color) {
        var ref3;
...
(function() {
  ...
  SubmitWorkFeaturesController = function($scope, $rootScope, SubmitWorkService, SubmitWorkAPIService, API_URL, RequirementService) {
    var activate, config, configureUploader, getUpdates, onChange, unsaved, vm;
    vm = this;
    vm.workId = $scope.workId;
    vm.loading = true;
    ...
    vm.applyFeature = function() {
      vm.features.forEach(function(feature) {
        if (feature.id === vm.activeFeature.id) {
          return unsaved.features.push(feature);
        }
      });
      vm.activeFeature = null;
      return onChange();
    ...
    vm.removeFeature = function() {
      unsaved.features.forEach(function(feature, index) {
        if (feature.title === vm.activeFeature.title) {
          return unsaved.features.splice(index, 1);
        }
      });
      vm.activeFeature = null;
      return onChange();
    ...
    getUpdates = function() {
      ...
      unsaved.features.forEach(function(feature) {
    ...
    onChange = function() {
      ...
      return unsaved.features.forEach(function(feature) {
        if (feature.custom) {
...
(function() {
  ...
  SubmitWorkDevelopmentController = function($scope, $rootScope, SubmitWorkService, API_URL) {
    var activate, configureUploader, onChange, vm;
    vm = this;
    vm.loading = true;
    vm.workId = $scope.workId;
    vm.showUploadModal = false;
    ...
    onChange = function() {
      ...
      return vm.work.numberOfApiIntegrations = work.numberOfApiIntegrations;
    };
    activate = function() {
      var destroyWorkListener;
      destroyWorkListener = $rootScope.$on("SubmitWorkService.work:changed", function() {
