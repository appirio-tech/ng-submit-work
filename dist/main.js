...
(function() {
  ...
  SubmitWorkVisualController = function($scope, $rootScope, $state, SubmitWorkService, SubmitWorkUploaderService, RequirementService) {
    ...
    vm.checkAddressValidity = function() {
      var urlValid;
      urlValid = vm.urlRegEx.test(vm.url);
      return vm.urlError = !urlValid;
    };
    ...
    getUpdates = function() {
      ...
      updates = {
        ...
        designUrls: vm.url && !vm.urlError ? [transformToUrl(vm.url)] : null
      };
      return updates;
    };
